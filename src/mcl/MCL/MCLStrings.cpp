...
MCLSTR_DEFINE(pl1, "PL1");
MCLSTR_DEFINE(pl2, "PL2");
MCLSTR_DEFINE(ro1, "RO1");
MCLSTR_DEFINE(ro2, "RO2");
MCLSTR_DEFINE(tro, "TRO");
MCLSTR_DEFINE(op, "OP");
MCLSTR_DEFINE(euc, "EUC");
MCLSTR_DEFINE(euc_or, "OR");
MCLSTR_DEFINE(euc_xor, "XOR");
MCLSTR_DEFINE(euc_and, "AND");
MCLSTR_DEFINE(euc_sub, "SUB");
